...
The idea is that anyone can see that their vote is there with their reciept, however, they can actually _decrypt_ and _validate_ that who they voted for is who they voted for... then, by combining a few keys together, anyone can _tally_ all of the votes themselves. This is leveraging tFHE to accomplish the tallying by utilizing public key, private key, cloud key encryption. 

## What This Demonstrates

- Kotlin JVM backend with Ktor
- Rust TFHE bridge exposed through JNI
- Encrypted one-hot ballot representation
- Homomorphic tally preparation
- Receipt-based voter verification
- Mask/decrypt/unmask tally workflow
- SolidStart frontend for ballot, lookup, verification, and tally flows
